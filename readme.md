# Variable numeric set with units question type [![Build Status](https://travis-ci.org/moodleou/moodle-qtype_varnumunit.svg?branch=master)](https://travis-ci.org/moodleou/moodle-qtype_varnumunit)
